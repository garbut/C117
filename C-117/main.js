...
element_of_drawing = quick_draw_data_set[random_no]
document.getElementById('drawn_sketch').innerText = element_of_drawing
...
function check_sketch()
{
    ...
    document.getElementById('timer').innerText = "time passed is:" + timer_counter
...
function got_result(error,result)
{
    if(error)
      ...
      {
        console.log(results);
        document.getElementById("").innerHTML = 'Label: ' + results[0].label;
